...
<head>
  ...
  <title>Lead With Us</title>

  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">

  <meta name="viewport" content="width=device-width, initial-scale=1.0">

  <meta name="description" content="Lead With Us">

  <meta name="keywords" content="Lead With Us">

  <meta name="author" content="Lead With Us">

  <link href="<?= base_url('assets/images/gigtodoFav.ico'); ?>" rel="shortcut icon" type="image/x-icon">
  ...
  <link href="<?= base_url('assets/css/categories_nav_styles.css'); ?>" rel="stylesheet">

  <!-- <link href="styles/step.css" rel="stylesheet">-->

  <link href="<?= base_url('assets/css/knowledge_bank.css'); ?>" rel="stylesheet">

  <link href="<?= base_url('assets/css/foopicker.css'); ?>" rel="stylesheet">

  <link href="<?= base_url('assets/css/pikaday.css'); ?>" rel="stylesheet">

  <link href="<?= base_url('assets/css/sweat_alert.css'); ?>" rel="stylesheet">
  ...
  <link href="<?= base_url('assets/css/leader.css'); ?>" rel="stylesheet">
  ...
  <script src="<?= base_url('assets/js/foopicker.js'); ?>" type="text/javascript"></script>

  <script src="<?= base_url('assets/js/pikaday.js'); ?>" type="text/javascript"></script>

  <script src="<?= base_url('assets/js/sweat_alert.js'); ?>" type="text/javascript"></script>

  <script src="<?= base_url('assets/js/StepFormValidation.js'); ?>" type="text/javascript"></script>
  ...
  <header class="border-bottom">
        ...
        <div class="row py-2">
          ...
          <div class="col-md-6 col-sm-6 col-4">
            ...
            <div class="text-right pr-lg-4">
              ...
              <a class="btn btn-link mr-2 text-dark" href="<?= base_url('login_buyer'); ?>">Login</a>

              <a class="btn btn-success hidden-xs" href="<?= base_url('leader'); ?>" role="button"><i class="fa fa-user-circle-o text-white" aria-hidden="true"></i> Join as a Leader</a>
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <a class="navbar-brand" href="<?= base_url(); ?>"><img class="desktop" src="<?= base_url('assets/images/lead-logo.png'); ?>" width="210"></a>
  ...
  <div class="modal fade" id="service1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <form method="POST" action="<?= base_url('home/moving_modal'); ?>">
          ...
          <div class="con_tab">
            ...
            <div style="display:none;" class="tab tab1" data-row="2">
              ...
              <div class="tab_btns"> <button type="button" id="prevBtn" onclick="nextPrev(0)">Previous</button> <button type="button" id="nextBtn" onclick="nextPrev(2)" style="display:none;">Next</button> <button type="button" id="validate_btn" value="2">Next</button></div>
            ...
            <div style="display:none;" class="tab tab2" data-row="3">
              ...
              <div class="tab_btns"> <button type="button" id="prevBtn" onclick="nextPrev(1)">Previous</button> <button type="button" id="nextBtn" onclick="nextPrev(3)" style="display:none;">Next</button> <button type="button" id="validate_btn" value="3">Next</button></div>
            ...
            <div style="display:none;" class="tab tab3" data-row="4">
              ...
              <div class="tab_btns"> <button type="button" id="prevBtn" onclick="nextPrev(2)">Previous</button> <button type="button" id="nextBtn" onclick="nextPrev(4)" style="display:none;">Next</button> <button type="button" id="validate_btn" value="4">Next</button></div>
            ...
            <div style="display:none;" class="tab tab4" data-row="5">
              ...
              <div class="tab_btns"> <button type="button" id="prevBtn" onclick="nextPrev(3)">Previous</button> <button type="button" id="nextBtn" onclick="nextPrev(5)" style="display:none;">Next</button> <button type="button" id="validate_btn" value="5">Next</button></div>
            ...
            <div style="display:none;" class="tab tab5" data-row="6">
              ...
              <div class="tab_btns"><button type="button" id="prevBtn" onclick="nextPrev(4)">Previous</button><button type="button" id="nextBtn" onclick="nextPrev(6)" style="display:none;">Next</button><button type="button" id="validate_btn" value="6">Next</button></div>
            ...
            <div style="display:none;" class="tab tab6" data-row="7">
              ...
              <div class="tab_btns"> <button type="button" id="prevBtn" onclick="nextPrev(5)">Previous</button> <button type="button" id="nextBtn" onclick="nextPrev(7)" style="display:none;">Next</button> <button type="button" class="wait_btn" id="validate_btn" value="7">Next</button></div>

            </div>

            <div style="display:none;" class="tab tab7" data-row="8">

              <div id="leader_serching"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;background:#fff;display:block;" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
              ...
              <div id="leader_serched" style="display:none;">
                ...
                <div class="svg-container"><svg class="ft-green-tick" height="100" width="100" viewBox="0 0 48 48" aria-hidden="true">
            ...
            <div style="display:none;" class="tab tab8" data-row="9">
              ...
              <p class="tab_inner_radio formid"><input type="hidden" value="Form submitted" name="submit"></p><input type="submit" name="submit" id="submit_btn" value="Submit">
