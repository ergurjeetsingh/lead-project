...
<section class="home-section">
   <div class="container">
      <div class="row">
               ...
               <form action="" method="post">
                  <div class="input-group form-group row" id="home_search_query">
                     ...
                     <div class="input-group-append move-icon-up">
                        ...
                        <img src="<?= base_url('assets/images/srch2.png'); ?>" class="srch2">
                        </button>
                     </div>
                  </div>
         ...
         <div class="col-md-5" style="margin-top: 7em;">
            <img class="man-img" src="<?= base_url('assets/images/man-lead.png'); ?>">
         </div>
      </div>
   </div>
</section>
               ...
               <div class="row">
                     ...
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service1" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/truckloading.jpg'); ?>" class="">
                           </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service2" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/239GeneralPlumbing.jpg'); ?>" class="">
                           </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/240elecrician.jpg'); ?>" class="">
                           </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/cleaning-image.jpg'); ?>" class="">
                           </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/242gardening.jpg'); ?>" class="">
                           </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/243hconstruction.jpg'); ?>" class="">
                           </div>
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-6 mb-5">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/Web development.jpg'); ?>" class="239">
                           </div>
                  ...
                  <div class="col-md-4 col-sm-6 mb-5">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/SEO.jpg'); ?>" class="239">
                           </div>
                  ...
                  <div class="col-md-4 col-sm-6 mb-5">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/Social Media.jpg'); ?>" class="239">
                           </div>
                  ...
                  <div class="col-md-4 col-sm-6 mb-5">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/Digital marketing.jpg'); ?>" class="239">
                           </div>
                  ...
                  <div class="col-md-4 col-sm-6 mb-5">
                     <div class="service-item">
                        <a href="#" class="services" data-toggle="modal" data-target="#service" data-whatever="@mdo" value="">
                           <div class="service-image-wrapper img-fluid">
                              <img src="<?= base_url('assets/images/Help with managing websites.jpg'); ?>" class="239">
                           </div>
      ...
      <div class="row pt-5 px-lg-5">
         ...
         <div class="col-md-6 col-sm-12">
            <div class="text-center">
               <img src="<?= base_url('assets/images/we-do.png'); ?>" style="width:100%;height:auto;">
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="row py-5 pb-3">
         ...
         <div class="col-6">
            <div class="text-right">
               <a href="<?= base_url('home/view_service') ?>" class="btn btn-link btn-lg">View</a>
            </div>
         </div>
      ...
      <div class="row py-5 pb-3">
         ...
         <div class="col-md-4 col-sm-6 mb-1">
            <div class="service-item">
               <a href="#">
                  <div class="service-image-wrapper img-fluid">
                     <img src="<?= base_url('assets/images/default.jpg'); ?>" class="">
                  </div>
